...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md" }, _attrs))} data-v-cb650fc1><div class="flex justify-between items-center mb-4" data-v-cb650fc1><button class="${ssrRenderClass([prevButtonColor.value, "text-white px-4 py-2 rounded"])}" data-v-cb650fc1>Önceki Ay</button><h1 class="text-2xl font-bold text-center" data-v-cb650fc1>${ssrInterpolate(formath1(currentMonth.value), { locale: unref(tr) })}</h1><button class="${ssrRenderClass([nextButtonColor.value, "text-white px-4 py-2 rounded"])}" data-v-cb650fc1>Sonraki Ay</button></div><div class="grid grid-cols-7 gap-4 text-center font-semibold text-gray-600" data-v-cb650fc1><!--[-->`);
      ...
      if (isModalOpen.value) {
        _push(`<div class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center" data-v-cb650fc1><div class="bg-white rounded-lg p-4 max-w-xl w-full space-y-4" data-v-cb650fc1><div class="flex justify-between items-center" data-v-cb650fc1><h2 class="text-xl font-bold" data-v-cb650fc1>Eğitim Özeti ${ssrInterpolate(formatDate(selectedDate.value))}</h2><button class="text-gray-600" data-v-cb650fc1>X</button></div><ul data-v-cb650fc1><!--[-->`);
...
//# sourceMappingURL=takvim-BhuPkwSE.js.map
