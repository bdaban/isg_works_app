    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(paginatedCalisanlar), (calisan) => {
        ...
        if (calisan.saglikRaporlari.length) {
          _push(`<div><div>${ssrInterpolate(calculateDaysRemaining(calisan.saglikRaporlari[calisan.saglikRaporlari.length - 1].gecerlilikTarihi))} - g\xFCn </div></div>`);
        } else {
          _push(`<div> - </div>`);
        }
        _push(`</td><td class="p-3">`);
        if (calisan.saglikRaporlari.length) {
          _push(`<div><div><a${ssrRenderAttr("href", calisan.saglikRaporlari[calisan.saglikRaporlari.length - 1].raporUrl)} target="_blank"><span class="text-lg text-red-700">Raporu G\xF6r\xFCnt\xFCle</span></a></div></div>`);
        } else {
          _push(`<div> Sa\u011Fl\u0131k raporu yok </div>`);
        }
        _push(`</td><td class="p-3">`);
        if (calisan.sertifikalar.length) {
          _push(`<div><div>${ssrInterpolate(calculateDaysRemaining(calisan.sertifikalar[calisan.sertifikalar.length - 1].gecerlilikTarihi))} - g\xFCn </div></div>`);
        } else {
          _push(`<div> - </div>`);
        }
        _push(`</td><td class="p-3">`);
        if (calisan.sertifikalar.length) {
          _push(`<div><div><a${ssrRenderAttr("href", calisan.sertifikalar[calisan.sertifikalar.length - 1].sertifikaUrl)} target="_blank"><span class="text-lg text-blue-500">Sertikika G\xF6r\xFCnt\xFCle</span></a></div></div>`);
        } else {
        ...
        if (unref(activeDropdown) === calisan.id) {
          ...
          _push(` D\xFCzenle </button></li><li><button class="w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center">`);
          _push(ssrRenderComponent(_component_Icon, {
            name: "mdi-delete",
            class: "w-4 h-4 mr-2"
          }, null, _parent));
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                return [
                  ...
                  createTextVNode(" Belge Y\xFCkle ")
                ];
              }
            }),
            _: 2
...
//# sourceMappingURL=index-BsxUa5Jo.mjs.map
