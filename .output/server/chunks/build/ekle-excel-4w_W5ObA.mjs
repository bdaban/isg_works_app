...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 max-w-full mx-auto bg-white rounded-lg shadow-lg" }, _attrs))}><h1 class="text-2xl font-semibold mb-6">Excel ile \xC7al\u0131\u015Fan Ekle</h1><div class="mb-4"><a href="/ornek_calisanlar_format.xlsx" download class="bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-md"> \xD6rnek Excel Dosyas\u0131n\u0131 \u0130ndir </a></div><form><input type="file" accept=".xlsx, .xls" class="mb-4">`);
      if (!isUploading.value) {
        _push(`<button type="submit" class="bg-blue-600 text-white py-2 px-4 rounded-md"> Y\xFCkle </button>`);
      } else {
        _push(`<!---->`);
      }
      if (isUploading.value) {
...
//# sourceMappingURL=ekle-excel-4w_W5ObA.mjs.map
